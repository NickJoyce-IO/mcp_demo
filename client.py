...
async def handle_query(session: ClientSession, query: str, openai_client: AsyncOpenAI, openai_model: str) -> ChatCompletion:
...
async def main():
    ...
    try:
        ...
        async with create_mcp_session(server_path) as session:
            ...
            query = "I need to host a web application for my new digital service. What platform can I use to host this web application?"
